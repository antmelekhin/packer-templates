...
#         $null = New-ItemProperty -Path $_.PSPath -Name 'StateFlags0012' -Value '2' -PropertyType 'DWord'
#     }

#     # Run Cleanmgr utility
#     Write-Output 'Running CleanMgr with Sagerun:12'
#     Start-Process -FilePath "$env:SystemRoot\system32\cleanmgr.exe" -ArgumentList '/sagerun:12' -Wait
