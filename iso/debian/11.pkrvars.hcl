...
vm_guest_distr_version = "11"

// VirtualBox specific settings
vbox_guest_os_type = "Debian_64"

// Removable media settings
iso_checksum_file = "https://cdimage.debian.org/cdimage/archive/11.10.0/amd64/iso-cd/SHA256SUMS"
iso_urls = [
  "../../_images/debian-11.10.0-amd64-netinst.iso",
